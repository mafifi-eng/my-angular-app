...
@Component({
  selector: 'app-SeoudiParserComponent',
  templateUrl: 'seoudi-parser.component.html',
  styleUrls: ['seoudi-parser.component.css']
})
export class SeoudiParserComponent implements OnInit {
