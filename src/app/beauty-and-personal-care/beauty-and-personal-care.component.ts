...
@Component({
  selector: 'app-beauty-and-personal-care',
  templateUrl: './beauty-and-personal-care.component.html',
  styleUrl: './beauty-and-personal-care.component.css'
})
export class BeautyAndPersonalCareComponent {
  errorMessage: string = '';
  categoryName: string = 'beauty-and-personal-care';
  products: any[] = [];
  pageSize: number = 10;
  page: number = 0;
  totalItems: number = 0;
